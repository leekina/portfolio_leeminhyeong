...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1885: l => arrayFromDartList(Uint8Array, l),
      ...
      _1895: l => arrayFromDartList(Array, l),
      _1896: (s, length) => {
        if (length == 0) return '';
      ...
      _1905: (o, p) => o[p],
      _1906: (o, p, v) => o[p] = v,
      _1907: (o, m, a) => o[m].apply(o, a),
      _1909: o => String(o),
      _1910: (p, s, f) => p.then(s, f),
      _1911: o => {
      ...
      _1938: (o, p) => o[p],
      _1941: v => v.toString(),
      _1942: (d, digits) => d.toFixed(digits),
      _1946: x0 => x0.random(),
      _1947: x0 => x0.random(),
      _1951: () => globalThis.Math,
